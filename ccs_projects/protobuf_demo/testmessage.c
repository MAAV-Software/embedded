...
void testmessage_clear(struct testmessage *_testmessage) {
	_memset(_testmessage, 0, sizeof(struct testmessage));
}

void testmessage_init_optional_attributes(struct testmessage *_testmessage) {
}

int testmessage_is_default_message(struct testmessage *_testmessage) {
    return _testmessage->_i32thefirst == 0
    
     && _testmessage->_i32thesecond == 0
    ;
}
...
int testmessage_write(struct testmessage *_testmessage, void *_buffer, int offset) {
	...
	if (_testmessage->_i32thefirst >= 0)
	    offset = write_raw_varint32(_testmessage->_i32thefirst, _buffer, offset);
	else
	    offset = write_raw_varint64(_testmessage->_i32thefirst, _buffer, offset);	    
	
	offset = write_raw_varint32((2<<3)+0, _buffer, offset);
	if (_testmessage->_i32thesecond >= 0)
	    offset = write_raw_varint32(_testmessage->_i32thesecond, _buffer, offset);
	else
	    offset = write_raw_varint64(_testmessage->_i32thesecond, _buffer, offset);	    
...
int testmessage_write_with_tag(struct testmessage *_testmessage, void *_buffer, int offset, int tag) {
	...
	/* Write content.*/
	offset = testmessage_write_delimited_to(_testmessage, _buffer, offset);
...
int testmessage_write_delimited_to(struct testmessage *_testmessage, void *_buffer, int offset) {
	...
	new_offset = testmessage_write(_testmessage, _buffer, offset);
...
int testmessage_read(void *_buffer, struct testmessage *_testmessage, int offset, int limit) {
	...
	testmessage_clear(_testmessage);
	/* Assign the optional attributes. */
	testmessage_init_optional_attributes(_testmessage);
	...
	while(offset < limit) {
		...
		tag = tag>>3;
	    switch(tag){
	        /* tag of: _testmessage._i32thefirst */
	        case 1 :
	        	offset = read_raw_varint32(&tag, _buffer, offset);
	        	_testmessage->_i32thefirst = (int32_t)tag;
	        	break;
	        /* tag of: _testmessage._i32thesecond */
	        case 2 :
	        	offset = read_raw_varint32(&tag, _buffer, offset);
	        	_testmessage->_i32thesecond = (int32_t)tag;
	        	break;
	    }
	}
...
int testmessage_read_delimited_from(void *_buffer, struct testmessage *_testmessage, int offset) {
	...
	offset = read_raw_varint32(&size, _buffer, offset);
	testmessage_read(_buffer, _testmessage, offset, size + offset);
