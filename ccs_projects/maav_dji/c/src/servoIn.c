...
void servoIn_attachPin(void) {
	...
	const uint32_t GPIO_MASK_A =         GPIO_PIN_2 |     GPIO_PIN_3 |     GPIO_PIN_5 |     GPIO_PIN_6 |     GPIO_PIN_7;
	const uint32_t GPIO_INT_MASK_A = GPIO_INT_PIN_2 | GPIO_INT_PIN_3 | GPIO_INT_PIN_5 | GPIO_INT_PIN_6 | GPIO_INT_PIN_7;
	...
	const uint32_t GPIO_MASK_E =         GPIO_PIN_1 |     GPIO_PIN_2 |     GPIO_PIN_3 |     GPIO_PIN_4 |     GPIO_PIN_5;
	const uint32_t GPIO_INT_MASK_E = GPIO_INT_PIN_1 | GPIO_INT_PIN_2 | GPIO_INT_PIN_3 | GPIO_INT_PIN_4 | GPIO_INT_PIN_5;
...
void servoIn_PortA_IntHandler(void) {	// This port is reserved for signals from the RC controller.
	...
	const uint32_t pinMask = GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7;
