...
int64_t __setpt_t_hash_recursive(const __lcm_hash_ptr *p)
{
    ...
    const __lcm_hash_ptr cp = { p, (void*)__setpt_t_get_hash };
    (void) cp;

    int64_t hash = 0x1fffb817de5069bcLL
...
int __setpt_t_encode_array(void *buf, int offset, int maxlen, const setpt_t *p, int elements)
{
    ...
    for (element = 0; element < elements; element++) {
        ...
        thislen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &(p[element].setptType), 1);
        if (thislen < 0) return thislen; else pos += thislen;
...
int __setpt_t_encoded_array_size(const setpt_t *p, int elements)
{
    ...
    for (element = 0; element < elements; element++) {
        ...
        size += __int8_t_encoded_array_size(&(p[element].setptType), 1);
...
int __setpt_t_decode_array(const void *buf, int offset, int maxlen, setpt_t *p, int elements)
{
    ...
    for (element = 0; element < elements; element++) {
        ...
        thislen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &(p[element].setptType), 1);
        if (thislen < 0) return thislen; else pos += thislen;
...
int __setpt_t_decode_array_cleanup(setpt_t *p, int elements)
{
    ...
    for (element = 0; element < elements; element++) {
        ...
        __int8_t_decode_array_cleanup(&(p[element].setptType), 1);
...
int __setpt_t_clone_array(const setpt_t *p, setpt_t *q, int elements)
{
    ...
    for (element = 0; element < elements; element++) {
        ...
        __int8_t_clone_array(&(p[element].setptType), &(q[element].setptType), 1);
